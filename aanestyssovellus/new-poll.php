...
if(isset($_POST['submit'])){
    ...
    if(empty($poll_topic) || empty($poll_option1) || empty($poll_option2) || empty($poll_option3) || empty($poll_time)){
        ...
        try {
            ...
            $sql = "INSERT INTO polls (poll_topic, poll_time, poll_option1, poll_option2, poll_option3)
            VALUES ('$poll_topic' , '$poll_time' , '$poll_option1' , '$poll_option2' , '$poll_option3')";
            // use exec() because no results are returned
            $conn->exec($sql);
            header('location:poll-create.php?success');
